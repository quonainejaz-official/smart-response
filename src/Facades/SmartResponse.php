...
namespace Vendor\SmartResponse\Facades;

use Illuminate\Support\Facades\Facade;
use Vendor\SmartResponse\Contracts\SmartResponseManagerInterface;

/**
 * @method static \Symfony\Component\HttpFoundation\Response respond(\Vendor\SmartResponse\DTO\SmartResponsePayload $payload, ?\Illuminate\Http\Request $request = null)
 ...
 *
 * @see \Vendor\SmartResponse\Services\SmartResponseManager
 */
